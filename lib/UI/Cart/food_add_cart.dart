...
import 'package:simple/UI/Cart/Widget/toggle_cart_button.dart';
        ...
        child: SingleChildScrollView(
          child: ConstrainedBox(
            constraints: BoxConstraints(
              ...
              //     0.8, // Or remove if parent scrolls
              minWidth: 0,
            ),
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ToggleButtonTab(label: "Dine In", selected: true),
                    ToggleButtonTab(label: "Take Away", selected: false),
                    Spacer(),
                    Text("Bills",
                        style: TextStyle(
