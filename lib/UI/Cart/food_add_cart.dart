        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Replace the toggle widget with this
              Row(
                children: [
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isDineInSelected ? Color(0xFF522F1F) : Colors.grey.shade300,
                        ...
                        child: Center(
                          child: Text(
                            "Dine In",
                            style: TextStyle(
                              color: isDineInSelected ? Colors.white : Colors.black,
                            ),
                          ),
                        ),
                      ),
              ...
              Row(
                children: [
                  Spacer(),
                  Text("Bills", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              ...
              Row(
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset('assets/image/almond.jpg', width: 10, height: 10),
                  ),
                  SizedBox(width: 12),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Veg Burger", style: TextStyle(fontWeight: FontWeight.bold)),
                        Text("x 1"),
                        SizedBox(height: 4),
                        Text("Base Price   ₹ 59.32"),
                        Text("SGST (9%)   ₹ 5.34"),
                        Text("CGST (9%)   ₹ 5.34"),
                        Text("Item Total   ₹ 59.32", style: TextStyle(fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                  Row(
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text("₹ 70.00", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              ]),
              ...
              if (!isSplitPayment) ...[
                ...
                SingleChildScrollView(
                  ...
                  child: Wrap(
                    ...
                    runSpacing: 12,
                    children: [
                      PaymentOption(icon: Icons.money, label: "Cash", selected: true),
                      PaymentOption(icon: Icons.credit_card, label: "Card", selected: false),
                      // PaymentOption(icon: Icons.qr_code, label: "UPI", selected: false),
                      PaymentOption(
                        icon: Icons.qr_code,
                        label: "UPI",
                        selected: false,
                        onTap: () {
                          Navigator.push(context,
                            MaterialPageRoute(builder: (_) => RazorpayQRScreen(
                              paymentUrl: "http://rzp.io/l6MS", // replace with real
                             ),
                               ),);
                          },
                      ),
              ...
              ElevatedButton(
                ...
                child: Text("Print Bills", style: TextStyle(color: Colors.white)),
              ),
            ],
          ),
        ),
